/**
 * Home Page
 * Landing page with local authentication
 */
...
const features = [
  ...
  },
  {
    icon: Lock,
    title: 'Secure Login',
    description: 'Create an account and sign in to access protected analysis features',
  },
];
...
const steps = [
  {
    ...
    description: 'Create an account or sign in with your email to unlock analysis features.',
  },
  {
    step: '02',
...
export function HomePage() {
  ...
  const { logout, email, isLoading, isAuthenticated, checkAuth } = useAuthStore();
        ...
        <div className="container-narrow flex justify-between items-center h-16">
          ...
          {isAuthenticated ? (
            <div className="flex items-center gap-3">
              ...
              <Button variant="secondary" size="sm" onClick={logout} isLoading={isLoading}>
                Logout
              </Button>
            </div>
          ) : (
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container-narrow">
          ...
          <section className="text-center py-12 md:py-20">
            ...
            >
              Understand your mental well-being through AI-powered analysis of your Social media activity
            </motion.p>
            ...
            {isAuthenticated ? (
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.3 }}
              >
                <Button onClick={() => navigate('/auth')} isLoading={isLoading} size="lg" fullWidth>
                  Sign In to Continue
                </Button>
              </motion.div>
            )}
